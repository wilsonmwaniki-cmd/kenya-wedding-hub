      ...
      <AnimatePresence initial={false}>
        {!assistantPanel.open ? (
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            className={`fixed right-3 z-[35] grid h-12 w-12 place-items-center overflow-hidden rounded-full border border-primary/30 bg-primary p-0 text-left text-primary-foreground shadow-card bottom-[calc(env(safe-area-inset-bottom)+5rem)] sm:bottom-[calc(env(safe-area-inset-bottom)+5.5rem)] sm:right-4 sm:block sm:h-auto sm:w-[calc(100vw-2rem)] sm:max-w-[420px] sm:rounded-2xl sm:p-3.5 lg:bottom-6 lg:right-5 ${
