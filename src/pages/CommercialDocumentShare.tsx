...
export default function CommercialDocumentShare() {
  ...
  if (loading) {
    return (
      <div className="flex min-h-screen items-center justify-center bg-[#f7f3ef] px-6">
        <div className="flex items-center gap-3 border border-border bg-white px-5 py-4 text-sm text-muted-foreground">
  ...
  if (!document) {
    return (
      <div className="flex min-h-screen items-center justify-center bg-[#f7f3ef] px-6">
        <div className="max-w-md border border-border bg-white p-8 text-center">
          <BrandWordmark size="sm" className="mb-8" />
          ...
          <Button asChild variant="outline" className="mt-6">
            <Link to="/dashboard">Back to wedding home</Link>
          </Button>
        </div>
      </div>
    );
